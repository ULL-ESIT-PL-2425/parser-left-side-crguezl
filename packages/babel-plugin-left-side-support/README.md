...
The basic idea behind this library is that functions as an abstraction can be considered a very 
special data structure and that any other data structure 
